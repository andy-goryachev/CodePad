	...
	extends ComboBox<Object>
{
	...
	public DoubleChoice(String name, Property<Number> p)
	{
	...
	public static DoubleChoice of(String name, Property<Number> p, Number ... items)
	{
		DoubleChoice c = new DoubleChoice(name, p);
		for(Number n: items)
		{
			c.add(n);
		}
